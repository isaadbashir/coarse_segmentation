...
class DataReader(BaseDataset):
    ...
    def preprocess_for_train(self, image, mask, pixel_mask):
        '''
        ...
        random.seed(11)
        augmented = self.transform(image=image, mask1 = mask, mask2 = pixel_mask)

        return augmented['image'], augmented['mask1'], augmented['mask2']
